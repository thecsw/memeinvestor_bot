...
where *A* and *m* are constants (*A=0.17366* , *m=0.2818*) and *x* is the change in upvotes
...
at ~500, and levelling off towards higher upvote changes. 
There is also an upper cap imposed on the function at 750,000 upvotes with a max multiplier of approximately
7.847 times the original investment. Any gain in upvotes at or above this cap will recieve this maximum multiplier. 
