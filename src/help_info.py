...
help_dict = {
    ...
    'promote': "Promotes the user with the given username (they must be a member of your firm). If the user is a Floor Trader (default rank), they are promoted to Executive. If they are an Executive and you are the CEO, you swap ranks with them.",
