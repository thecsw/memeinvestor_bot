...
+ The return curve's maximum decreases as $v_0$ increases. Thus, small-cap
  investments have *high* potential returns (up to \sim310%), while large-cap
  investments have *low* potential returns (as low as \sim5%).
...
at least 200, your return will be \sim260%.
...
500 upvotes or more, the return will be \sim115%. Beyond this, the return caps out at \sim123%
